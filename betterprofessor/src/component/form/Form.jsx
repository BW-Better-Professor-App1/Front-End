    ...
    <Fragment>
      ...
      <form className={classes.root} onSubmit={handleSubmit}>
        {inputData.map(inputData => {
          return <FormElement inputData={inputData} key={inputData.label} updateCredentials={updateCredentials} />;
        })}
        <Button className={classes.button} variant={variant} color={color} type="submit">
          {text}
        </Button>
      </form>
    </Fragment>
